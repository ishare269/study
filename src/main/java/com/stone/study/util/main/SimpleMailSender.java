package com.stone.study.util.main;
...
public class SimpleMailSender {
	...
	public static void main(String[] args) {
		...
		// mailInfo.attachFile("C:/Users/Administrator/Desktop/JVM.jpg");
		mailInfo.setMailServicerHost("smtp.qq.com");
		mailInfo.setMailServiceProt("465");
		mailInfo.setValidate(true);
//		mailInfo.setUserName("yushigui1990@foxmail.com");
//		mailInfo.setPassword("Yushigui910211");
//		mailInfo.setFromAddress("yushigui1990@foxmail.com");
		
		
//		mailInfo.setUserName("538163@qq.com");
//		mailInfo.setPassword("jiangzhaodi0328");
//		mailInfo.setFromAddress("538163@qq.com");
		
		
		mailInfo.setUserName("495631701@qq.com");
		mailInfo.setPassword("st0tencent_9759");
		mailInfo.setFromAddress("495631701@qq.com");
