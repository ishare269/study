package com.stone.third._99dou;
...
public class _99douInterface {
	/**
	 * 登录名: stoneflame (UID:208) 代理商编号: 10204
	 * 密钥：wEb58M8aRJLKGEuTah2GcWVolB9TW8RqkzxLjCfMdhvXr7mN8XcuIdT3GPi3DDnA
	 */
	//代理商ID
	private String partner = "10204";
	//密钥
	private String key = "wEb58M8aRJLKGEuTah2GcWVolB9TW8RqkzxLjCfMdhvXr7mN8XcuIdT3GPi3DDnA";
	//久久数字服务器提交地址
	private String host = "http://api2.99dou.com:8000/Api/Service";
	//代理商提供的操作异步回调 链接地址
	private String notify_url = "http://10.0.1.85/study/_99dou_notify.jsp";
	//编码
	...
	public _99douInterface() {
		...
		// this.partner = "10001";
		// this.key =
		// "5ts6KCQMXn58EjOeVOwVU4JhgepluTbqMUrSafrkFKZvGdjHrsSNliopwtcdAgm1";
		// this.notify_url = "http://10.0.1.85/study/_99dou_notify.jsp";
	}
		...
		if (map.containsKey("_sign")
			...
			if (status.equals("success") || status.equals("fail")) {
				success_qty.setValue(Integer.parseInt(map
						...
						: ""));
				fail_qty.setValue(Integer
						.parseInt(map.containsKey("fail_qty") ? map
								.get("fail_qty") : ""));
