...
<html>
<head>
<title>HTML5 Audio Tag Detail</title>
...
<body>
	<audio id="myAudio" controls><!-- hidden="true"  autoplay="autoplay"-->
	<source
		src="${pageContext.request.contextPath }/resources/music/audio.ogg"
		type="audio/ogg"> <source
		src="${pageContext.request.contextPath }/resources/music/audio.mp3"
		type="audio/mpeg"></audio>
	<br />
	<br />
	<h3>Exception:</h3>
	<span>HTTP“Content-Type”中的“audio/mpeg”不支持。媒体资源audio.mp3 加载失败。</span>
	<!--done-->
	<div class="post">
		<div id="cnblogs_post_body">
			<table class="table" style="width:100%; text-align: center;"
				...
				<caption>
					<a href="http://www.cnblogs.com/linn/p/3408515.html"
						target="_blank">不同浏览器对于html5
				</caption>
				<tbody>
					<tr>
						<td valign="top"><strong>音频格式</strong></td>
						<td valign="top"><strong>Chrome</strong></td>
						<td valign="top"><strong>Firefox</strong></td>
						<td valign="top"><strong>IE9</strong></td>
				...
				<tfoot>
					<tr>
						<td colspan="6">一般提供ogg和mp3格式，就可以支持所有主流浏览器了。</td>
					</tr>
				</tfoot>
			</table>
			<br /> <br />
			<table class="toolTable table" width="100%" cellspacing="0"
				cellpadding="0">
				<caption>
					<a href="http://tool.oschina.net/commons" target="_blank">Content-type对照表</a>
				</caption>
				<tr>
			...
			<a href="http://www.tuicool.com/articles/iuyAfyi">http://www.tuicool.com/articles/iuyAfyi</a>
			...
			<mime-mapping> <extension>mp3</extension> <mime-type>audio/mpeg</mime-type>

			</mime-mapping>

			果然结果出来了，这样就可以完全IE、FF都可以加载了。 记录分享一下，如果有哪位遇到相同的问题，可以参照一下。

			希望那位兄弟也能解决这个问题。下面给一下Web.xml常用的MIME的类型配置：

			<mime-mapping> <extension>doc</extension> <mime-type>application/msword</mime-type>
			...
			<mime-mapping> <extension>zip</extension> <mime-type>application/zip</mime-type>

			</mime-mapping>

			<mime-mapping> <extension>rar</extension> <mime-type>application/rar</mime-type>

			</mime-mapping>

			<mime-mapping> <extension>txt</extension> <mime-type>application/txt</mime-type>

			</mime-mapping>

			<mime-mapping> <extension>chm</extension> <mime-type>application/mshelp</mime-type>

			</mime-mapping>

			<mime-mapping> <extension>mp3</extension> <mime-type>audio/x-mpeg</mime-type>
